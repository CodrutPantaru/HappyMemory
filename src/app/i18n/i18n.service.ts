...
const STRINGS: Record<LanguageCode, Record<string, string>> = {
  ro: {
    ...
    'home.history': 'Istoric',
    'home.historyTitle': 'Istoric jocuri si scoruri',
    'home.bestScore': 'Cel mai bun scor',
    'home.historyEmpty': 'Nu exista jocuri salvate inca.',
    'home.historyScore': 'Scor',
    'home.historyMoves': 'Mutari',
    'pack.mode.label': 'Tip selectie pachet',
    'pack.mode.single': 'Singular',
    'pack.mode.mixed': 'Mixt',
    ...
    'category.utilityCars': 'Vehicule utilitare',
  ...
  en: {
    ...
    'home.historyTitle': 'Game history and scores',
    'home.bestScore': 'Best score',
    'home.historyEmpty': 'No saved games yet.',
    'home.historyScore': 'Score',
    'home.historyMoves': 'Moves',
    'pack.mode.label': 'Pack selection mode',
    'pack.mode.single': 'Single',
    'pack.mode.mixed': 'Mixed',
    ...
    'category.utilityCars': 'Utility Cars',
    'paywall.title': 'Premium',
  ...
  fr: {
    ...
    'home.historyTitle': 'Historique des parties et scores',
    'home.bestScore': 'Meilleur score',
    'home.historyEmpty': "Aucune partie enregistree pour l'instant.",
    'home.historyScore': 'Score',
    'home.historyMoves': 'Coups',
    'pack.mode.label': 'Mode de selection',
    'pack.mode.single': 'Simple',
    'pack.mode.mixed': 'Mixte',
    ...
    'category.utilityCars': 'Vehicules utilitaires',
    'paywall.title': 'Premium',
  ...
  es: {
    ...
    'home.historyTitle': 'Historial de partidas y puntuaciones',
    'home.bestScore': 'Mejor puntuacion',
    'home.historyEmpty': 'Aun no hay partidas guardadas.',
    'home.historyScore': 'Puntuacion',
    'home.historyMoves': 'Movimientos',
    'pack.mode.label': 'Modo de seleccion',
    'pack.mode.single': 'Unico',
    'pack.mode.mixed': 'Mixto',
    ...
    'category.hospital': 'Hospital',
    'category.utilityCars': 'Vehiculos utilitarios',
    'paywall.title': 'Premium',
  ...
  de: {
    ...
    'home.historyTitle': 'Spielverlauf und Punktzahlen',
    'home.bestScore': 'Bester Punktestand',
    'home.historyEmpty': 'Noch keine gespeicherten Spiele.',
    'home.historyScore': 'Punkte',
    'home.historyMoves': 'Zuege',
    'pack.mode.label': 'Paket-Auswahlmodus',
    'pack.mode.single': 'Einzeln',
    'pack.mode.mixed': 'Gemischt',
    ...
    'category.utilityCars': 'Nutzfahrzeuge',
    'paywall.title': 'Premium',
